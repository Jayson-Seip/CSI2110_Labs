...
public class SequenceTester {
    ...
    static void CrazyTest(Sequence<Integer> S) {
		...
		System.out.println("\nIndex at position Test for linked");
		System.out.println(S.indexAtPosition(S.positionAtIndex(0)));
		System.out.println(S.indexAtPosition(S.positionAtIndex(5)));
		System.out.println(S.indexAtPosition(S.positionAtIndex(S.size()-1)));
		System.out.println(S.indexAtPosition(S.positionAtIndex(6)));
		System.out.println();
